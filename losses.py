...
def depth_loss(y_true, y_pred, theta=0.1, device="cuda"):
    ...
    dy_true, dx_true = compute_image_gradients(y_true) # TODO get the images gradients of the true data 
    dy_pred, dx_pred = compute_image_gradients(y_pred) # TODO get the images gradients of the predicted data 
